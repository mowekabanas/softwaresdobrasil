...
function twentysixteen_setup() {
	...
	register_nav_menus( array(
		...
		'header-menu'  => __( 'Header Menu', 'twentysixteen' ),
		'main'  => __( 'Menu de Categorias', 'twentysixteen' ),
	) );
...
function twentysixteen_scripts() {
	...
	wp_enqueue_style( 'villa', get_template_directory_uri() . '/dist/css/villa.min.css' );
	wp_enqueue_style( 'style', get_template_directory_uri() . '/dist/css/softwaresdobrasil.css' );
